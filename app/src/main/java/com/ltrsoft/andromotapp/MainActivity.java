...
import static com.ltrsoft.andromotapp.fragment.NavigationDrawerFragment.drawerLayout;
...
import com.ltrsoft.andromotapp.fragment.Dashboard;
...
import com.ltrsoft.andromotapp.fragment.NavigationDrawerFragment;
...
//Don't remove this method it's important
    @Override
    public void onBackPressed() {
        if (NavigationDrawerFragment.drawerLayout.isDrawerOpen(GravityCompat.START)) {
            NavigationDrawerFragment.drawerLayout.closeDrawer(GravityCompat.START);
        } else {
