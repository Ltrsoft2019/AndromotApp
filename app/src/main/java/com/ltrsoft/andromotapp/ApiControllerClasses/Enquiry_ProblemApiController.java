...
public class Enquiry_ProblemApiController {
    ...
    Enquiry_ProblemApiController getapi()
    {

        return retrofit.create( Enquiry_ProblemApiController.class);
    }
}
