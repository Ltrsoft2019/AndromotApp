...
public class ServiceServerApiController {
    ...
    ServiceServerApiController  getapi()
    {
        return retrofit.create( ServiceServerApiController .class);
    }
